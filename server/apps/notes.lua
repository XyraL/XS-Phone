PhoneCallback('cipher-phone:notes:list', function(src)
...
PhoneCallback('cipher-phone:notes:save', function(src, data)
...
PhoneCallback('cipher-phone:notes:delete', function(src, data)
    local me = GetPhoneNumber(src)
    if not me then return { ok = false, error = 'no_phone' } end
